...
void GPIO_Init()
{
    ...
    GPIOB_CRL_struct.bits.mode3 = 1; //output 10MHz
    GPIOB_CRL_struct.bits.cnf3 = 0; //push-pull
}
...
int main()
{
    ...
    while (1)
    {
        ...
        {
            GPIOB_BSRR_struct.bits.bs3 = 1; //LED on
        }
        else
        {
            GPIOB_BRR_struct.bits.br3 = 1 ; //LED off
        }
    }
